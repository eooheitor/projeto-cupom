...
<body class="bg-gray-100 flex h-screen" x-data="{ sidebarOpen: true }">
    <aside :class="sidebarOpen ? 'w-64' : 'w-16'"
        ...
        <div class="h-16 flex items-center px-6 border-b bg-[#8a1590]"
        ...
        <nav class="flex-1 p-4 space-y-2">
            ...
            <a href="#"
                ...
                <span x-show="sidebarOpen" class="whitespace-nowrap font-medium">Cupons</span>
            </a>
            ...
            <a href="#"
                ...
                <span x-show="sidebarOpen" class="whitespace-nowrap font-medium">Tarefas</span>
            </a>
